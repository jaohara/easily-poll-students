    ...
    <div className="user-dashboard">
      ...
      <div className="user-dashboard-description">
        ...
        <p>
          ...
          function exported from the AppDataContext and use the navigate
          function to handle the redirect.
        </p>

        <p>
          <strong>
            This is also where the &quot;Create Poll&quot; button will be
            displayed.
          </strong>
        </p>

        <p>
          The list of polls can be accessed from{' '}
          <strong>allUserPollsData</strong> from the AppDataContext.
        </p>
      </div>
      ...
      <div className="user-dashboard-controls">
        <EpButton
          onClick={() => {
            navigate(getRoutePathByName('Create Poll'))
          }}
        >
          Create Poll
        </EpButton>
  ...
  return (
    ...
    >
      ...
      <div className="dashboard-item-pill-container">
        ...
        <EpPill key="is-active">{isActive ? 'Active' : 'Completed'}</EpPill>
        {
          // TODO: Is this info relevant here?
        }
        <EpPill key="is-locked">{isLocked ? 'Locked' : 'Unlocked'}</EpPill>
      </div>
      <div className="dashboard-item-temp-controls-container">
        <EpButton key="vote-button" onClick={guestVotingNavHandler}>
          Guest Voting Page
        </EpButton>
        <EpButton
